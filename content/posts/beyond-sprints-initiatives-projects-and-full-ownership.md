...
**Owner** — every project has one named engineering owner who is accountable for it landing end to end. Often there's a second or third engineer working alongside them, depending on the size of the project. The owner's job isn't to personally do every part of the work. It's to make sure the work gets done, and done well. They drive the scope, the approach, and the decisions; they make sure the project moves; they stay on the hook from kickoff through shipping and post-launch metrics. The actual code, design, and review is shared across whoever is on the project. What isn't shared is responsibility for the outcome.
